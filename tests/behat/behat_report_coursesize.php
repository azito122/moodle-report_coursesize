...
class behat_report_coursesize extends behat_base {
    /**
     * I generate the test files
     *
     * @Given /^I generate the test files$/
     */
    public function i_set_report_roster_flatnav_position_to() {
        $size = 2000000; // 2 MB.
        $data = str_repeat(rand(0,9), $size);
        file_put_contents(__DIR__ . '/../fixtures/testfile1.txt', $data); //writes $data in a file
    }
