...
$string['table:column_header:id'] = 'ID';
$string['table:column_header:idnumber'] = 'ID Number';
$string['build_status'] = 'Build Status';
$string['build_status_active'] = 'Step {$a->step} / {$a->steptotal} (%{$a->percent}) of stage {$a->stage}';
$string['build_status_none'] = 'No active build';
$string['no_results'] = 'There are no results cached at this time. A new build has been triggered; when it is complete, the cache will be updated and this page will show actual data.';
$string['settings:iteration_limit'] = 'Adhoc Task Batch Limit';
$string['settings:iteration_limit:description'] = 'Limit on iterations within one execution of the data building adhoc task.';
$string['settings:cache_lifetime'] = 'Cache Lifetime (hours)';
$string['settings:cache_lifetime:description'] = 'How long (in hours) before the cache is considered stale and a new build is triggered.';