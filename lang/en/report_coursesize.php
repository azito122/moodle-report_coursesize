...
$string['settings:batch_limit'] = 'Adhoc Task Batch Limit';
$string['settings:batch_limit:description'] = 'Limit on iterations within one execution of the data building adhoc task.';
